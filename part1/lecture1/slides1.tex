...
\begin{frame}[t]{关于课程}
    \begin{block}
        ...
        \begin{itemize}
            ...
            \item 课件开源发布
                \begin{itemize}
                    \item \scriptsize{\sout{\url{https://bitbucket.org/rezilla/open-lecture-notes.git}}}
                    \item \scriptsize{\url{https://github.com/zhileiren/open-lecture-notes.git}}
                \end{itemize}
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}[t]{(重)读经典}
    \includegraphics[width=.4\textwidth]{Mythical Man-Month.jpg}
\end{frame}
% section 特色栏目 (end)
\section{教学内容} % (fold)
\label{sec:教学内容}
